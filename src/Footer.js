...
<div className = "row" style={{width:'105%',padding:'25px',backgroundColor:'#E3E2DF'}}>
<div  className = "col-sm-6">
<h3 style={{marginLeft:'200px', fontFamily:'sans-serif',fontSize:'20px',color:'black'}}>Mark Yousrelf First To Know</h3>
<h3 style={{marginLeft:'200px', fontFamily:'sans-serif',fontSize:'17px',color:'black'}}>Stay in touch to find out the best offers and exclusive news.</h3>
</div>

<div className="ui input col-sm-6">
<input type="email" placeholder="Type your email..." style={{marginLeft:'50px',height:'50px'}}></input> 
