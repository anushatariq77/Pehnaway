...
return(
    ...
    <div className = "container-xl" style = {{marginLeft: '80px'}}>
      <div className = "jumbotron">
      <h3 style={{textAlign:'center',fontWeight:'bold',padding:'50px',fontFamily:'sans-serif',letterSpacing:'4px',color:'#666666',fontSize:'16px'}}>PEHNAWAY WOMEN 'S CLOTHING ONLINE SHOPPING IN PAKISTAN</h3>
      <hr style={{height:'0px',backgroundColor:'#666666',width:'75%'}}></hr>
       <p style={{padding:'100px', paddingTop: '0px', display:'block',textAlign:'center', fontFamily:'sans-serif',color:'#666666'}}>Pehnaway provides an aggereageted platform to all the rising clothing brands. 
       ...
       <div  className= "jumbotron">
       <h2 style={{textAlign:'center',fontWeight:'bold',padding:'50px',fontFamily:'sans-serif',letterSpacing:'4px',color:'#666666',fontSize:'16px'}}>Winter And Festive Collections 2019</h2>
